...
%---Constellation in different SNR---
signal_15=Dn_16qam_mod+sigma_16QAM(16)*(randn(1,nsymbol_16QAM)+1i*randn(1,nsymbol_16QAM));
signal_25=Dn_16qam_mod+sigma_16QAM(26)*(randn(1,nsymbol_16QAM)+1i*randn(1,nsymbol_16QAM));
...
hold off;
title('16QAM constellation when SNR=15');
grid on;
figure();
plot(signal_25,'ro');
hold on;
plot(Dn_16qam_mod,'ko','MarkerFaceColor','k');
hold off;
title('16QAM constellation when SNR=25');
grid on;
